...
HD_PWD='C:/users/administrator/Downloads/simple_VGA-master/simple_VGA/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_rxd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_rxd.tcl
