...
HD_PWD='C:/users/administrator/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_image.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_image.tcl
